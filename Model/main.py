...
Prepros = Preproccesing(n_mels=80)
#spectro = Prepros.spec_Mel(paths,labels)
spectro = Prepros.spec_Mel([paths[15], paths[19]],[labels[15], labels[19]])
embed = torch.tensor([embedding[15], embedding[19]])
test = CE.forward(torch.tensor(spectro), embed)