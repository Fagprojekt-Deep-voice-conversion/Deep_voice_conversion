...
class TestDataset(object):
	...
	def __init__(self, config):
		...
		self.files_to_convert = config.files_to_convert
...
if __name__ == '__main__':
	...
	parser.add_argument('--files_to_convert', nargs='+', default=['random'], help='add the number of the speaker files to convert, e.g. 026')
