...
###BSUB -w "ended(7121354)"
### -- Specify the output and error file. %J is the job-id --
### -- -o and -e mean append, -oo and -eo mean overwrite --
#BSUB -o StarGAN_20min_%J.out
#BSUB -e StarGAN_20min_%J.err
# -- end of LSF options --
...
datadir=/work1/s183920/Deep_voice_conversion/data/train_data/StarGAN/20min
